...
//                        println("nodeIdEntry: username")
//                    }
//                    if (nodeIdEntry.contains("pass")) {
//                        foundPasswordLabel = true
//                        println("nodeIdEntry: password")
//                    }
//                }
...
//                    println("userNameId: $userName")
                ...
                if (node.autofillHints?.any { it.contains(View.AUTOFILL_HINT_PASSWORD, ignoreCase = true) } == true) {
                    if (setPasswordId != null && requestType == RequestType.OnFillRequest) {
                        setPasswordId(node.autofillId!!)
                    }
                    if (setPasswordValue != null && requestType == RequestType.OnSaveRequest) {
